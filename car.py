...
mask = cv2.imread("images/mask5.png")
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            try:
                ...
                if classNames[cls] == "car" or classNames[cls] == "bus" or classNames[cls] == "truck" or classNames[cls] == "motorbike":
                    currentClass = classNames[cls]
                elif classNames[cls+1] == "car" or classNames[cls+1] == "bus" or classNames[cls+1] == "truck" or classNames[cls+1] == "motorbike":
                    currentClass = classNames[cls+1]
                elif classNames[cls+2] == "car" or classNames[cls+2] == "bus" or classNames[cls+2] == "truck" or classNames[cls+2] == "motorbike":
                    currentClass = classNames[cls+2]
                elif classNames[cls+3] == "car" or classNames[cls+3] == "bus" or classNames[cls+3] == "truck" or classNames[cls+3] == "motorbike":
